        ...
        <div className="bg-theme-secondary rounded-xl p-6 border border-theme">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-theme-primary font-medium">lucas.ryq@gmail.com</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-theme-primary font-medium">n</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-theme-primary font-medium">Santa Luzia, MG</p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-8 pt-6 border-t border-theme">
            ...
            <div className="flex space-x-3">
              ...
              <a href="#" className="w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center hover:bg-gray-900 transition-colors">
        ...
        <div className="bg-theme-secondary rounded-xl p-6 border border-theme">
          ...
          <form className="space-y-4">
            <div>
              ...
              <input type="text" className="w-full px-4 py-3 bg-theme-primary border border-theme rounded-lg text-theme-primary placeholder-theme-secondary focus:outline-none focus:border-theme-accent" placeholder="Seu nome completo" />
            </div>
            ...
            <div>
              ...
              <input type="email" className="w-full px-4 py-3 bg-theme-primary border border-theme rounded-lg text-theme-primary placeholder-theme-secondary focus:outline-none focus:border-theme-accent" placeholder="seu@email.com" />
            </div>
            ...
            <div>
              ...
              <input type="text" className="w-full px-4 py-3 bg-theme-primary border border-theme rounded-lg text-theme-primary placeholder-theme-secondary focus:outline-none focus:border-theme-accent" placeholder="Nome da empresa" />
            </div>
            ...
            <div>
              ...
              <textarea rows={4} className="w-full px-4 py-3 bg-theme-primary border border-theme rounded-lg text-theme-primary placeholder-theme-secondary focus:outline-none focus:border-theme-accent resize-none" placeholder="Conte sobre sua oportunidade..." />
            </div>

            <button type="submit" className="w-full bg-theme-accent hover:bg-theme-accent-hover text-theme-accent-text py-3 rounded-lg font-medium transition-colors">
              Enviar Mensagem
            </button>
          </form>
        </div>
