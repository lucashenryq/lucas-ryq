  ...
  return <div className="space-y-4">
      ...
      <div className="bg-theme-secondary rounded-xl p-6 border border-theme">
        ...
        <div className="relative">
          ...
          <p className="text-theme-secondary text-left leading-relaxed pl-4">Estudante de IA e entusiasta maximalista do Bitcoin. Conhecimento em programação, modelos de IA e economia. Proatividade e honestidade como principais qualidades.</p>
        </div>

        </div>

      {/* Skills Section with Achievement Badge */}
      <div className="bg-theme-secondary rounded-xl p-6 border border-theme">
        <h3 className="font-semibold text-theme-primary mb-4">Competências</h3>
        <div className="space-y-3 mb-6">
          {skills.map((skill, index) => <div key={index} className="flex items-center justify-between">
